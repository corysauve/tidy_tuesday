...
# Fig - Average visitors since 1995 for the 25 most popular national parks 
```{r}
...
# Fig - Number of visitors of top four parks 
```{r}
...
p_top_four_parks <- top_parks %>% 
  ...
  ggtitle("Visitors to Top National Parks") +
